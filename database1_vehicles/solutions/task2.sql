-- Задача 2: Объединённая выборка по автомобилям, мотоциклам и велосипедам с заданными критериями
SELECT
    v.maker,
    v.model,
    c.horsepower,
    ROUND(c.engine_capacity, 2)::text AS engine_capacity,
    'Car' AS vehicle_type
FROM
    Car c
...
SELECT
    ...
    v.model,
    m.horsepower,
    ROUND(m.engine_capacity, 2)::text AS engine_capacity,
